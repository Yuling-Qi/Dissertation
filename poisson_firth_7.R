...
calculate_metrics_k7 <- function(n, betas) {
...
results_k7 <- calculate_metrics_k7(n, betas)

# Extract specific values from the results and combine them into a comma-separated string
separation_values <- paste(sapply(results_k7, function(result) result$separation), collapse = ",")
RMSE_beta_values <- paste(sapply(results_k7, function(result) result$RMSE_beta), collapse = ",")
RMSE_prediction_values <- paste(sapply(results_k7, function(result) result$RMSE_prediction), collapse = ",")
coverage_prob_values <- paste(sapply(results_k7, function(result) result$coverage.prob), collapse = ",")
