...
# Define a function to simulate a Poisson regression model for k=7
...
calculate_metrics_k7_firth <- function(n, betas) {
...
results_k7_firth <- calculate_metrics_k7_firth(n, betas)

# Extract specific values from the results and combine them into a comma-separated string
RMSE_prediction_values_firth <- paste(sapply(results_k7_firth, function(result) result$RMSE_prediction), collapse = ",")
